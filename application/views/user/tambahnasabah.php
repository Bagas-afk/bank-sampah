    ...
    <div class="ro pb-3">
        <form action="<?= base_url('user/tambahAksi') ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="number" name="nik" class="form-control" id="inputEmail3" maxlength="16" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="date" name="tanggal_lahir" class="form-control" id="inputPassword3" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <textarea rows="6" type="text" name="alamat" class="form-control" id="inputPassword3" required></textarea>
                </div>
            </div>
            <fieldset class="form-group">
                <div class="row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" name="email" class="form-control" id="email" placeholder="user@example.com" required>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input class="form-control-file" type="file" id="image" name="file" required>
                </div>
            </div>
